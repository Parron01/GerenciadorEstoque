...
<template>
  <div class="container mx-auto px-4 py-6 md:py-8 max-w-6xl">
    ...
    <header class="mb-6 md:mb-8">
      <h1 class="text-2xl md:text-3xl font-bold text-indigo-700 mb-2">Gerenciamento de Estoque</h1>
      <p class="text-gray-600">Controle entradas e saídas de produtos com facilidade</p>
      <div
